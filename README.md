...
Support for [ESP32-C6-Touch-LCD-1.47](https://docs.waveshare.com/ESP32-C6-Touch-LCD-1.47) with a special touch slid keybroad 
...
```
Step 1: Touch edge (left/right) → select ROW (vertical position)
              ↓
